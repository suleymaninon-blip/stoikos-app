...
const UI: Record<Lang, Dict> = {
  ...
  tr: {
    ...
    'mood.title': 'Nasıl hissediyorsun?', 'wisdom.byAuthor': 'Filozofa göre',
  ...
  en: {
    ...
    'mood.title': 'How do you feel?', 'wisdom.byAuthor': 'By philosopher',
  ...
  de: {
    ...
    'mood.title': 'Wie fühlst du dich?', 'wisdom.byAuthor': 'Nach Philosoph',
  ...
  ru: {
    ...
    'mood.title': 'Как ты себя чувствуешь?', 'wisdom.byAuthor': 'По философу',
  ...
  fr: {
    ...
    'mood.title': 'Comment te sens-tu ?', 'wisdom.byAuthor': 'Par philosophe',
  ...
  es: {
    ...
    'mood.title': '¿Cómo te sientes?', 'wisdom.byAuthor': 'Por filósofo',
