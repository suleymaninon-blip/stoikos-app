...
const UI: Record<Lang, Dict> = {
  ...
  tr: {
    ...
    'practice.journalTag': 'GÜNLÜK YANSIMA', 'practice.journalHistory': 'Geçmiş →', 'practice.journalCoachNote': 'Yazdıkların koçunun seni daha iyi tanımasına yardımcı olur. Cihazında saklanır.', 'journal.title': 'Yansımaların', 'journal.subtitle': 'Geçmiş günlerde kendine bıraktığın notlar.', 'journal.empty': 'Henüz yansıma yok. Pratik ekranından bir not bırak.',
  ...
  en: {
    ...
    'practice.journalTag': 'DAILY REFLECTION', 'practice.journalHistory': 'History →', 'practice.journalCoachNote': 'What you write helps your coach know you better. Stored on your device.', 'journal.title': 'Your reflections', 'journal.subtitle': 'Notes you left yourself on past days.', 'journal.empty': 'No reflections yet. Leave a note from the Practice screen.',
  ...
  de: {
    ...
    'practice.journalTag': 'TÄGLICHE REFLEXION', 'practice.journalHistory': 'Verlauf →', 'practice.journalCoachNote': 'Was du schreibst, hilft deinem Coach, dich besser zu kennen. Auf deinem Gerät gespeichert.', 'journal.title': 'Deine Reflexionen', 'journal.subtitle': 'Notizen, die du dir an früheren Tagen hinterlassen hast.', 'journal.empty': 'Noch keine Reflexionen. Hinterlasse eine Notiz im Übungsbereich.',
  ...
  ru: {
    ...
    'practice.journalTag': 'ЕЖЕДНЕВНАЯ РЕФЛЕКСИЯ', 'practice.journalHistory': 'История →', 'practice.journalCoachNote': 'То, что ты пишешь, помогает коучу лучше тебя понять. Хранится на твоём устройстве.', 'journal.title': 'Твои размышления', 'journal.subtitle': 'Заметки, оставленные себе в прошлые дни.', 'journal.empty': 'Пока нет размышлений. Оставь заметку на экране практики.',
  ...
  es: {
    ...
    'practice.journalTag': 'REFLEXIÓN DIARIA', 'practice.journalHistory': 'Historial →', 'practice.journalCoachNote': 'Lo que escribes ayuda a tu coach a conocerte mejor. Se guarda en tu dispositivo.', 'journal.title': 'Tus reflexiones', 'journal.subtitle': 'Notas que te dejaste en días pasados.', 'journal.empty': 'Aún no hay reflexiones. Deja una nota desde la pantalla de Práctica.',
