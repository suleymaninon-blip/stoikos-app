...
const UI: Record<Lang, Dict> = {
  ...
  tr: {
    ...
    'paywall.body': 'Ücretsiz beş sorunun doldu. Koçla konuşmaya devam etmek için abone olabilirsin.',
  ...
  en: {
    ...
    'paywall.body': 'You have used your five free questions. Subscribe to keep talking with the coach.',
  ...
  de: {
    ...
    'paywall.body': 'Du hast deine fünf kostenlosen Fragen genutzt. Abonniere, um weiter mit dem Coach zu sprechen.',
  ...
  ru: {
    ...
    'paywall.body': 'Вы использовали пять бесплатных вопросов. Оформите подписку, чтобы продолжить общение с коучем.',
  ...
  fr: {
    ...
    'paywall.body': 'Tu as utilisé tes cinq questions gratuites. Abonne-toi pour continuer à parler avec le coach.',
  ...
  es: {
    ...
    'paywall.body': 'Has usado tus cinco preguntas gratuitas. Suscríbete para seguir hablando con el coach.',
