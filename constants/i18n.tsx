...
const UI: Record<Lang, Dict> = {
  ...
  tr: {
    ...
    'paywall.title': 'Sınırsız Koç', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6,99 / ay',
    'paywall.frequency': 'Aylık otomatik yenileme',
    'paywall.body': 'Ücretsiz koç hakkın doldu. Konuşmaya devam etmek için abone olabilirsin.',
    'paywall.f1': 'Koçla sınırsız sohbet',
  ...
  en: {
    ...
    'paywall.title': 'Unlimited Coach', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6.99 / month',
    'paywall.frequency': 'Monthly automatic renewal',
    'paywall.body': 'You have used your free questions. Subscribe to keep talking with the coach.',
    'paywall.f1': 'Unlimited conversations with the coach',
    'paywall.f2': 'A continuing conversation that remembers you',
    'paywall.f3': 'In six languages, whenever you need it',
    'paywall.stillFree': 'Quotes, concepts, philosophers, breathing and practices stay free — always.',
    'paywall.termsNote': 'By subscribing, I agree to the Privacy Policy and Terms of Service.',
    'paywall.cta': 'SUBSCRIBE', 'paywall.soon': 'COMING SOON', 'paywall.close': 'Not now',
  ...
  de: {
    ...
    'paywall.title': 'Unbegrenzter Coach', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6,99 / Monat',
    'paywall.frequency': 'Automatische monatliche Verlängerung',
    'paywall.body': 'Du hast deine kostenlosen Fragen genutzt. Abonniere, um weiter mit dem Coach zu sprechen.',
    'paywall.f1': 'Unbegrenzte Gespräche mit dem Coach',
    'paywall.f2': 'Ein fortlaufendes Gespräch, das sich an dich erinnert',
    'paywall.f3': 'In sechs Sprachen, wann immer du willst',
    'paywall.stillFree': 'Zitate, Konzepte, Philosophen, Atmung und Übungen bleiben immer kostenlos.',
    'paywall.termsNote': 'Mit der Bestellung akzeptiere ich die Datenschutzerklärung und Nutzungsbedingungen.',
    'paywall.cta': 'ABONNIEREN', 'paywall.soon': 'DEMNÄCHST', 'paywall.close': 'Jetzt nicht',
  ...
  ru: {
    ...
    'paywall.title': 'Безлимитный коуч', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6,99 / месяц',
    'paywall.frequency': 'Автоматическое ежемесячное продление',
    'paywall.body': 'Вы использовали бесплатные вопросы. Оформите подписку, чтобы продолжить общение с коучем.',
    'paywall.f1': 'Неограниченные беседы с коучем',
    'paywall.f2': 'Непрерывный разговор, который вас помнит',
    'paywall.f3': 'На шести языках, в любой момент',
    'paywall.stillFree': 'Цитаты, понятия, философы, дыхание и практики остаются бесплатными — всегда.',
    'paywall.termsNote': 'Оформляя подписку, я согласен(а) с Политикой конфиденциальности и Условиями использования.',
    'paywall.cta': 'ОФОРМИТЬ ПОДПИСКУ', 'paywall.soon': 'СКОРО', 'paywall.close': 'Не сейчас',
  ...
  fr: {
    ...
    'paywall.title': 'Coach illimité', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6,99 / mois',
    'paywall.frequency': 'Renouvellement automatique mensuel',
    'paywall.body': 'Tu as utilisé tes questions gratuites. Abonne-toi pour continuer à parler avec le coach.',
    'paywall.f1': 'Conversations illimitées avec le coach',
    'paywall.f2': 'Une conversation continue qui se souvient de toi',
    'paywall.f3': 'En six langues, à tout moment',
    'paywall.stillFree': 'Les citations, concepts, philosophes, la respiration et les pratiques restent gratuits — toujours.',
    'paywall.termsNote': 'En m\'abonnant, j\'accepte la Politique de confidentialité et les Conditions d\'utilisation.',
    'paywall.cta': "S'ABONNER", 'paywall.soon': 'BIENTÔT', 'paywall.close': 'Pas maintenant',
  ...
  es: {
    ...
    'paywall.title': 'Coach ilimitado', 'paywall.subtitle': 'STOIKOS PLUS',
    'paywall.price': '$6,99 / mes',
    'paywall.frequency': 'Renovación automática mensual',
    'paywall.body': 'Has usado tus preguntas gratuitas. Suscríbete para seguir hablando con el coach.',
    'paywall.f1': 'Conversaciones ilimitadas con el coach',
    'paywall.f2': 'Una conversación continua que te recuerda',
    'paywall.f3': 'En seis idiomas, cuando lo necesites',
    'paywall.stillFree': 'Las citas, conceptos, filósofos, la respiración y las prácticas siguen siendo gratis — siempre.',
    'paywall.termsNote': 'Al suscribirme, acepto la Política de privacidad y los Términos de servicio.',
    'paywall.cta': 'SUSCRIBIRSE', 'paywall.soon': 'PRÓXIMAMENTE', 'paywall.close': 'Ahora no',
