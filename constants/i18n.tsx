...
const UI: Record<Lang, Dict> = {
  ...
  tr: {
    ...
    'mood.title': 'Nasıl hissediyorsun?', 'wisdom.byAuthor': 'Filozofa göre', 'wisdom.countLabel': 'alıntı', 'wisdom.empty': 'Bu seçimde alıntı yok.', 'wisdom.emptyFav': 'Henüz favorin yok. Bir alıntının kalbine dokun.',
  ...
  en: {
    ...
    'mood.title': 'How do you feel?', 'wisdom.byAuthor': 'By philosopher', 'wisdom.countLabel': 'quotes', 'wisdom.empty': 'No quotes for this selection.', 'wisdom.emptyFav': 'No favorites yet. Tap the heart on a quote.',
  ...
  de: {
    ...
    'mood.title': 'Wie fühlst du dich?', 'wisdom.byAuthor': 'Nach Philosoph', 'wisdom.countLabel': 'Zitate', 'wisdom.empty': 'Keine Zitate für diese Auswahl.', 'wisdom.emptyFav': 'Noch keine Favoriten. Tippe auf das Herz eines Zitats.',
  ...
  ru: {
    ...
    'mood.title': 'Как ты себя чувствуешь?', 'wisdom.byAuthor': 'По философу', 'wisdom.countLabel': 'цитат', 'wisdom.empty': 'Нет цитат для этого выбора.', 'wisdom.emptyFav': 'Пока нет избранного. Коснись сердечка на цитате.',
  ...
  fr: {
    ...
    'mood.title': 'Comment te sens-tu ?', 'wisdom.byAuthor': 'Par philosophe', 'wisdom.countLabel': 'citations', 'wisdom.empty': 'Aucune citation pour cette sélection.', 'wisdom.emptyFav': 'Pas encore de favoris. Touche le cœur d’une citation.',
  ...
  es: {
    ...
    'mood.title': '¿Cómo te sientes?', 'wisdom.byAuthor': 'Por filósofo', 'wisdom.countLabel': 'citas', 'wisdom.empty': 'No hay citas para esta selección.', 'wisdom.emptyFav': 'Aún no tienes favoritas. Toca el corazón de una cita.',
