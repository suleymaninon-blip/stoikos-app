...
const CONCEPTS_RAW: RawConcept[] = [
  { latin: 'Amor Fati', icon: '♾', color: 'rgba(212,146,74,0.15)',
    ...
    desc: {
      tr: 'Her olayı — acı veren ya da keyifli — olması gerektiği gibi kabul etmek. Dirençten değil kabulden güç doğar.\n\nBir şey ters gittiğinde zihin hep aynı cümleyi kurar: keşke olmasaydı. Saatlerce, bazen günlerce. Amor fati o cümleyi kesen şeydir.\n\nAma boyun eğmek değil — en sık yapılan yanlış anlama bu. Kabul etmek onaylamak demek değildir. "Bu iyiydi" demiyorsun; "bu oldu, şimdi elimde ne var" diyorsun. Biri seni geçmişte tutar, öbürü bugüne getirir.\n\nMarcus Aurelius bunu ateşle anlattı: harlı bir ateşe ne atarsan at, onu alevine katıp ışığa çevirir. Küçük bir alev sönerdi; büyüğü yakıta dönüştürür.\n\nBunu yazanların hayatı kolay değildi. Biri sürgün görmüş bir köleydi, öbürü salgının ortasında imparator. Rahat bir hayatın felsefesi değil bu — zor bir hayatta ayakta kalmanın felsefesi.',
      en: 'To accept every event — painful or pleasant — as it ought to be. Strength is born of acceptance, not resistance.\n\nWhen something goes wrong the mind keeps forming the same sentence: if only it hadn\'t happened. For hours, sometimes days. Amor fati is what cuts that sentence short.\n\nBut it is not submission — that is the usual misreading. Accepting is not approving. You are not saying "this was good"; you are saying "this happened, and what do I have now." One keeps you in the past; the other brings you back to today.\n\nMarcus Aurelius said it with fire: throw anything into a strong blaze and it takes it into the flame and turns it into light. A small flame would have gone out; a large one makes fuel of it.\n\nThe people who wrote this did not have easy lives. One was a slave, later exiled; the other an emperor during a plague. This is not the philosophy of a comfortable life — it is the philosophy of staying upright in a hard one.',
      de: 'Jedes Ereignis — schmerzhaft oder angenehm — so anzunehmen, wie es sein soll. Kraft entsteht aus Annahme, nicht aus Widerstand.\n\nWenn etwas schiefgeht, bildet der Kopf immer denselben Satz: wäre es doch nicht passiert. Stundenlang, manchmal tagelang. Amor fati ist das, was diesen Satz abschneidet.\n\nAber es ist keine Unterwerfung — das ist das übliche Missverständnis. Annehmen heißt nicht gutheißen. Du sagst nicht "das war gut", sondern "das ist geschehen, und was habe ich jetzt". Das eine hält dich in der Vergangenheit, das andere holt dich in den heutigen Tag.\n\nMark Aurel sagte es mit dem Feuer: wirf etwas in eine starke Flamme, und sie nimmt es auf und macht Licht daraus. Ein kleines Feuer wäre erloschen; ein großes macht Brennstoff daraus.\n\nDie das schrieben, hatten kein leichtes Leben. Der eine war ein Sklave, später verbannt; der andere Kaiser während einer Seuche. Das ist keine Philosophie des bequemen Lebens — es ist die Philosophie, in einem schweren aufrecht zu bleiben.',
      ru: 'Принимать всякое событие — болезненное или приятное — таким, каким оно должно быть. Сила рождается из принятия, а не из сопротивления.\n\nКогда что-то идёт не так, ум складывает одну и ту же фразу: если бы этого не случилось. Часами, иногда днями. Amor fati — это то, что обрывает эту фразу.\n\nНо это не покорность — обычная ошибка. Принять не значит одобрить. Ты не говоришь "это было хорошо"; ты говоришь "это случилось, и что у меня есть теперь". Одно держит тебя в прошлом, другое возвращает в сегодня.\n\nМарк Аврелий сказал это через огонь: брось что угодно в сильное пламя — оно примет это и обратит в свет. Маленький огонь потух бы; большой сделает из этого топливо.\n\nУ тех, кто это писал, жизнь не была лёгкой. Один был рабом, позже изгнанным; другой — императором во время эпидемии. Это не философия удобной жизни, а философия того, как устоять в тяжёлой.',
      fr: 'Accepter chaque événement — douloureux ou agréable — tel qu\'il doit être. La force naît de l\'acceptation, non de la résistance.\n\nQuand quelque chose tourne mal, l\'esprit refait toujours la même phrase : si seulement ce n\'était pas arrivé. Pendant des heures, parfois des jours. L\'amor fati, c\'est ce qui coupe cette phrase.\n\nMais ce n\'est pas de la soumission — c\'est le contresens habituel. Accepter n\'est pas approuver. Tu ne dis pas "c\'était bien" ; tu dis "c\'est arrivé, et qu\'est-ce qu\'il me reste". L\'un te garde dans le passé, l\'autre te ramène à aujourd\'hui.\n\nMarc Aurèle l\'a dit avec le feu : jette n\'importe quoi dans une flamme vive, elle le prend et en fait de la lumière. Une petite flamme se serait éteinte ; une grande en fait du combustible.\n\nCeux qui ont écrit cela n\'ont pas eu la vie facile. L\'un était un esclave, exilé ensuite ; l\'autre empereur pendant une peste. Ce n\'est pas la philosophie d\'une vie confortable — c\'est celle de tenir debout dans une vie dure.',
      es: 'Aceptar cada suceso — doloroso o placentero — tal como debe ser. La fuerza nace de la aceptación, no de la resistencia.\n\nCuando algo sale mal, la mente arma siempre la misma frase: ojalá no hubiera pasado. Durante horas, a veces días. El amor fati es lo que corta esa frase.\n\nPero no es sumisión — ese es el malentendido habitual. Aceptar no es aprobar. No dices "esto estuvo bien"; dices "esto ocurrió, y qué tengo ahora". Lo uno te mantiene en el pasado; lo otro te trae a hoy.\n\nMarco Aurelio lo dijo con el fuego: echa cualquier cosa a una llama fuerte y la toma y la vuelve luz. Una llama pequeña se habría apagado; una grande hace combustible de ello.\n\nQuienes escribieron esto no tuvieron una vida fácil. Uno fue esclavo y luego desterrado; el otro, emperador durante una peste. No es la filosofía de una vida cómoda, sino la de mantenerse en pie en una dura.' },
    example: {
      tr: 'İşini kaybettiğinde "keşke" döngüsünden çıkıp "bu oldu; şimdi elimde ne var?" diye sormak Amor Fati\'dir.',
      en: 'Losing your job and stepping out of the "if only" loop to ask "this happened; what do I have now?" — that is amor fati.',
      de: 'Den Job verlieren, aus der "hätte ich doch"-Schleife heraustreten und fragen: "das ist geschehen; was habe ich jetzt?" — das ist amor fati.',
      ru: 'Потерять работу, выйти из круга "если бы только" и спросить: "это случилось; что у меня есть теперь?" — вот amor fati.',
      fr: 'Perdre son emploi, sortir de la boucle du "si seulement" et demander : "c\'est arrivé ; qu\'est-ce qu\'il me reste ?" — voilà l\'amor fati.',
      es: 'Perder el trabajo, salir del bucle del "ojalá" y preguntar: "esto ocurrió; ¿qué tengo ahora?" — eso es amor fati.' },
    practice: {
