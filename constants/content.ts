...
const CONCEPTS_RAW: RawConcept[] = [
  { latin: 'Amor Fati', icon: '♾', color: 'rgba(212,146,74,0.15)',
    ...
    desc: {
      tr: 'Her olayı — acı veren ya da keyifli — olması gerektiği gibi kabul etmek. Dirençten değil kabulden güç doğar.\n\nAmor fati sık sık boyun eğmekle karıştırılır: "her şeye razı ol, sesini çıkarma" sanılır. Oysa kabul etmek onaylamak değildir. "Bu iyiydi" demiyorsun; "bu oldu, şimdi buradan ne yapacağım" diyorsun. Aradaki fark felsefeyi bir teselliden çıkarıp güç kaynağına çevirir: olmuş bir şeye direnmek enerjiyi değiştiremeyeceğin yere harcamaktır, kabul ise o enerjiyi bir sonraki seçimine bırakır. Marcus Aurelius bunu ateşle anlatır — harlı bir ateş, içine ne atarsan at, onu alevine katıp ışığa çevirir. Latince deyişi çok sonra Nietzsche ortaya attı, ama fikir Epiktetos ve Marcus\'ta zaten vardı; ikisi de sürgün, salgın ve tiranlık görmüş insanlardı. Bu, rahat bir hayatın felsefesi değil.',
      en: 'To accept every event — painful or pleasant — as it ought to be. Strength is born of acceptance, not resistance.\n\nAmor fati is often mistaken for resignation: "put up with everything and say nothing." But accepting is not approving. You are not saying "this was good"; you are saying "this happened — now what do I do from here." That difference turns the philosophy from a consolation into a source of strength: resisting what has already happened spends energy where nothing can change, while acceptance releases it into your next choice. Marcus Aurelius put it in terms of fire — a strong blaze takes whatever you throw in and turns it into light. The Latin phrase came much later, from Nietzsche, but the idea was already in Epictetus and Marcus; both had lived through exile, plague and tyranny. This is not the philosophy of a comfortable life.',
      de: 'Jedes Ereignis — schmerzhaft oder angenehm — so anzunehmen, wie es sein soll. Kraft entsteht aus Annahme, nicht aus Widerstand.\n\nAmor fati wird oft mit Resignation verwechselt: "ertrage alles und schweig." Doch annehmen heißt nicht gutheißen. Du sagst nicht "das war gut", sondern "das ist geschehen — was mache ich jetzt daraus." Dieser Unterschied macht aus der Philosophie statt eines Trostes eine Kraftquelle: sich gegen Geschehenes zu wehren verbraucht Kraft dort, wo nichts mehr zu ändern ist; Annahme gibt sie der nächsten Entscheidung frei. Mark Aurel sagte es im Bild des Feuers — eine starke Flamme nimmt alles auf, was man hineinwirft, und verwandelt es in Licht. Die lateinische Wendung stammt erst von Nietzsche, doch der Gedanke stand schon bei Epiktet und Mark Aurel; beide erlebten Verbannung, Seuche und Tyrannei. Das ist keine Philosophie des bequemen Lebens.',
      ru: 'Принимать всякое событие — болезненное или приятное — таким, каким оно должно быть. Сила рождается из принятия, а не из сопротивления.\n\nAmor fati часто путают с покорностью: будто нужно "всё стерпеть и молчать". Но принять — не значит одобрить. Ты не говоришь "это было хорошо"; ты говоришь "это случилось — что я сделаю дальше". Эта разница превращает философию из утешения в источник силы: сопротивление уже случившемуся тратит силы там, где ничего не изменить, а принятие отдаёт их следующему выбору. Марк Аврелий говорил об этом образом огня — сильное пламя принимает всё, что в него бросают, и обращает в свет. Латинское выражение появилось много позже, у Ницше, но мысль уже была у Эпиктета и Марка; оба знали изгнание, эпидемию и тиранию. Это не философия удобной жизни.',
      fr: 'Accepter chaque événement — douloureux ou agréable — tel qu\'il doit être. La force naît de l\'acceptation, non de la résistance.\n\nOn confond souvent l\'amor fati avec la résignation : "supporte tout et tais-toi". Mais accepter n\'est pas approuver. Tu ne dis pas "c\'était bien" ; tu dis "c\'est arrivé — qu\'est-ce que j\'en fais maintenant". Cette différence fait passer la philosophie de la consolation à la source de force : résister à ce qui a déjà eu lieu dépense l\'énergie là où rien ne peut changer, tandis que l\'acceptation la libère pour le choix suivant. Marc Aurèle l\'a dit par l\'image du feu — une flamme vive prend tout ce qu\'on y jette et le change en lumière. La formule latine est venue bien plus tard, de Nietzsche, mais l\'idée était déjà chez Épictète et Marc Aurèle ; tous deux ont connu l\'exil, la peste et la tyrannie. Ce n\'est pas la philosophie d\'une vie confortable.',
      es: 'Aceptar cada suceso — doloroso o placentero — tal como debe ser. La fuerza nace de la aceptación, no de la resistencia.\n\nEl amor fati suele confundirse con la resignación: "aguántalo todo y calla". Pero aceptar no es aprobar. No dices "esto estuvo bien"; dices "esto ocurrió — ¿qué hago ahora a partir de aquí?". Esa diferencia convierte la filosofía de consuelo en fuente de fuerza: resistirse a lo ya ocurrido gasta energía donde nada puede cambiar, mientras que la aceptación la libera para la siguiente elección. Marco Aurelio lo dijo con la imagen del fuego — una llama viva toma cuanto se le arroja y lo vuelve luz. La expresión latina llegó mucho después, de Nietzsche, pero la idea ya estaba en Epicteto y en Marco; ambos conocieron el exilio, la peste y la tiranía. Esta no es la filosofía de una vida cómoda.' },
    example: {
