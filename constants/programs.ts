...
const PROGRAMS_RAW: RawProgram[] = [
  ...
  // ════════ 7 Günde Zamanın Kısalığı ════════
  {
    id: 'time',
    icon: '⧗',
    color: 'rgba(160,120,170,0.18)',
    title: { tr: 'Zamanın Kısalığı', en: 'The Shortness of Time', de: 'Die Kürze der Zeit', ru: 'Краткость времени', fr: 'La brièveté du temps', es: 'La brevedad del tiempo' },
    subtitle: { tr: '7 günde ertelemeyi kırmak', en: 'Breaking postponement in 7 days', de: 'In 7 Tagen das Aufschieben brechen', ru: 'За 7 дней сломать откладывание', fr: 'Briser la remise à plus tard en 7 jours', es: 'Romper el aplazamiento en 7 días' },
    days: [
      { title: { tr: 'Nereye gidiyor', en: 'Where it goes', de: 'Wohin sie geht', ru: 'Куда оно уходит', fr: 'Où il passe', es: 'Adónde se va' },
        body: { tr: 'Seneca kısa bir ömür verilmediğini, onu bizim kısalttığımızı söyler. Bugün yargılamadan izle: saatler nereye gitti? Akşam hesabını yap ve açıklayamadığın süreyi yaz. Değiştirmek yarın.',
                en: 'Seneca says we are not given a short life — we make it short. Today just watch, without judging: where did the hours go? In the evening add them up and write down the time you cannot account for. Changing it is tomorrow.',
                de: 'Seneca sagt, uns sei kein kurzes Leben gegeben — wir machen es kurz. Beobachte heute nur, ohne zu urteilen: wohin gingen die Stunden? Rechne am Abend nach und schreib die Zeit auf, die du nicht erklären kannst. Das Ändern kommt morgen.',
                ru: 'Сенека говорит: нам дана не короткая жизнь — мы сами делаем её короткой. Сегодня просто наблюдай, не осуждая: куда ушли часы? Вечером подсчитай и запиши время, которое не можешь объяснить. Менять будем завтра.',
                fr: "Sénèque dit qu'on ne nous donne pas une vie courte — c'est nous qui la raccourcissons. Aujourd'hui, observe simplement, sans juger : où sont passées les heures ? Le soir, fais le compte et note le temps que tu ne peux pas expliquer. Changer, ce sera demain.",
                es: 'Séneca dice que no se nos da una vida corta: somos nosotros quienes la acortamos. Hoy solo observa, sin juzgar: ¿adónde se fueron las horas? Por la noche haz la cuenta y anota el tiempo que no puedes explicar. Cambiarlo será mañana.' } },
      { title: { tr: 'Ertelediğin tek şey', en: 'The one thing you postpone', de: 'Das eine Aufgeschobene', ru: 'То единственное, что ты откладываешь', fr: 'La seule chose que tu repousses', es: 'La única cosa que aplazas' },
        body: { tr: 'Liste yapma, bir tane seç. Aylardır ertelediğin o şey. Sonra yanına neden ertelediğini yaz — dürüstçe. Sebep genellikle zaman değildir; korku, belirsizlik ya da nereden başlayacağını bilmemektir.',
                en: 'Do not make a list; choose one. The thing you have been putting off for months. Then write next to it why — honestly. The reason is rarely time; it is fear, uncertainty, or not knowing where to start.',
                de: 'Mach keine Liste, wähl eine Sache. Das, was du seit Monaten aufschiebst. Schreib daneben, warum — ehrlich. Der Grund ist selten die Zeit; es ist Furcht, Ungewissheit oder nicht zu wissen, wo man anfängt.',
                ru: 'Не составляй список, выбери одно. То, что откладываешь месяцами. Потом напиши рядом почему — честно. Причина редко во времени; это страх, неясность или незнание, с чего начать.',
                fr: "Ne fais pas de liste, choisis une seule chose. Celle que tu repousses depuis des mois. Écris à côté pourquoi — honnêtement. La raison est rarement le temps ; c'est la peur, l'incertitude, ou ne pas savoir par où commencer.",
                es: 'No hagas una lista, elige una sola cosa. Esa que llevas meses aplazando. Luego escribe al lado por qué — con honestidad. La razón rara vez es el tiempo; es miedo, incertidumbre o no saber por dónde empezar.' } },
      { title: { tr: 'İlk beş dakika', en: 'The first five minutes', de: 'Die ersten fünf Minuten', ru: 'Первые пять минут', fr: 'Les cinq premières minutes', es: 'Los primeros cinco minutos' },
        body: { tr: 'Direnç işin kendisinde değil, başlangıcındadır. Bugün o işe beş dakika ver ve istersen bırak. Çoğu insan bırakmaz — çünkü zor olan başlamaktı, sürdürmek değil.',
                en: 'The resistance is not in the task, it is at its beginning. Give it five minutes today and stop if you want to. Most people do not stop — because the hard part was starting, not continuing.',
                de: 'Der Widerstand liegt nicht in der Aufgabe, sondern an ihrem Anfang. Gib ihr heute fünf Minuten und hör auf, wenn du willst. Die meisten hören nicht auf — denn schwer war das Anfangen, nicht das Weitermachen.',
                ru: 'Сопротивление не в самом деле, а в его начале. Дай ему сегодня пять минут и брось, если захочешь. Большинство не бросает — потому что трудным было начать, а не продолжить.',
                fr: "La résistance n'est pas dans la tâche, elle est à son commencement. Donne-lui cinq minutes aujourd'hui et arrête si tu veux. La plupart n'arrêtent pas — car le difficile était de commencer, non de continuer.",
                es: 'La resistencia no está en la tarea, sino en su comienzo. Dale hoy cinco minutos y para si quieres. La mayoría no para, porque lo difícil era empezar, no continuar.' } },
      { title: { tr: '"Sonra" ne zaman?', en: 'When is "later"?', de: 'Wann ist „später“?', ru: 'Когда наступит «потом»?', fr: "C'est quand, « plus tard » ?", es: '¿Cuándo es «luego»?' },
        body: { tr: 'Belirsiz gelecek hiçbir zaman gelmez. Bugün ertelediğin şeye bir gün ve bir saat ver, takvime yaz. Tarihi olmayan niyet niyet değildir; yalnızca kendine anlattığın bir hikâyedir.',
                en: 'A vague future never arrives. Give the thing you are postponing a day and an hour, and put it in the calendar. An intention without a date is not an intention; it is a story you tell yourself.',
                de: 'Eine vage Zukunft kommt nie. Gib dem Aufgeschobenen einen Tag und eine Stunde und trag es in den Kalender ein. Ein Vorsatz ohne Datum ist kein Vorsatz, sondern eine Geschichte, die du dir erzählst.',
                ru: 'Неопределённое будущее не наступает никогда. Назначь отложенному день и час и внеси в календарь. Намерение без даты — не намерение, а история, которую ты себе рассказываешь.',
                fr: "Un avenir vague n'arrive jamais. Donne à ce que tu repousses un jour et une heure, et inscris-le dans l'agenda. Une intention sans date n'est pas une intention ; c'est une histoire que tu te racontes.",
                es: 'Un futuro vago no llega nunca. Dale a lo que aplazas un día y una hora, y ponlo en el calendario. Una intención sin fecha no es una intención; es un cuento que te cuentas.' } },
      { title: { tr: 'Ödünç zaman', en: 'Borrowed time', de: 'Geliehene Zeit', ru: 'Взятое взаймы время', fr: 'Le temps emprunté', es: 'Tiempo prestado' },
        body: { tr: "İnsanlar parasını korur, zamanını savurur — oysa Seneca'ya göre cimriliğin onurlu olduğu tek şey zamandır. Bugün zamanını isteyen bir talebi reddet. Nazikçe, gerekçe sıralamadan.",
                en: 'People guard their money and squander their time — yet for Seneca, time is the one thing it is honourable to be greedy about. Today refuse one request for your time. Politely, without listing reasons.',
                de: 'Die Menschen hüten ihr Geld und verschwenden ihre Zeit — dabei ist die Zeit für Seneca das Einzige, bei dem Geiz ehrenhaft ist. Lehn heute eine Bitte um deine Zeit ab. Freundlich, ohne Begründungen aufzuzählen.',
                ru: 'Люди берегут деньги и расточают время — а между тем, по Сенеке, время единственное, в чём скупость почётна. Откажи сегодня одной просьбе о твоём времени. Вежливо, без перечисления причин.',
                fr: "Les gens gardent leur argent et gaspillent leur temps — pourtant, pour Sénèque, le temps est la seule chose où l'avarice est honorable. Refuse aujourd'hui une demande sur ton temps. Poliment, sans énumérer de raisons.",
                es: 'La gente guarda su dinero y derrocha su tiempo — y sin embargo, para Séneca, el tiempo es lo único en lo que la avaricia es honrosa. Hoy rechaza una petición sobre tu tiempo. Con amabilidad, sin enumerar motivos.' } },
      { title: { tr: 'Bugünü bitir', en: 'Finish today', de: 'Schließ den Tag ab', ru: 'Заверши сегодня', fr: 'Termine ta journée', es: 'Termina el día' },
        body: { tr: 'Günü açık uçlu bırakma. Akşam şu soruyu sor: bugünü tamamladım mı, yoksa yarına mı sarkıttım? Seneca, bugünü düzene koymuş kişinin yarından korkmayacağını söyler.',
                en: 'Do not leave the day open-ended. In the evening ask: did I finish today, or did I push it into tomorrow? Seneca says whoever has put today in order has no need to fear tomorrow.',
                de: 'Lass den Tag nicht offen enden. Frag am Abend: habe ich heute abgeschlossen, oder in den morgigen Tag geschoben? Seneca sagt: wer den heutigen Tag geordnet hat, muss den morgigen nicht fürchten.',
                ru: 'Не оставляй день незакрытым. Спроси вечером: я закончил сегодняшний день или перенёс его на завтра? Сенека говорит: кто привёл в порядок сегодня, тому незачем бояться завтра.',
                fr: "Ne laisse pas la journée ouverte. Le soir, demande : ai-je terminé aujourd'hui, ou l'ai-je repoussé à demain ? Sénèque dit que celui qui a mis de l'ordre dans son jour n'a pas à craindre le lendemain.",
                es: 'No dejes el día abierto. Por la noche pregunta: ¿terminé hoy, o lo empujé a mañana? Séneca dice que quien ha ordenado su día no necesita temer el siguiente.' } },
      { title: { tr: 'Son hafta provası', en: 'Rehearsing the last week', de: 'Die letzte Woche proben', ru: 'Репетиция последней недели', fr: 'La répétition de la dernière semaine', es: 'El ensayo de la última semana' },
        body: { tr: 'Bu korkutmak için değil: bu senin son haftan olsaydı, listendeki hangi maddeler bir anda anlamsızlaşır, hangileri yükselirdi? Yükselenleri not et. Önceliğin, o listedir.',
                en: 'This is not meant to frighten you: if this were your last week, which items on your list would suddenly mean nothing, and which would grow louder? Note the ones that grew louder. That list is your priority.',
                de: 'Das soll dich nicht erschrecken: wäre dies deine letzte Woche, welche Punkte deiner Liste wären plötzlich bedeutungslos und welche würden lauter? Halte die lauteren fest. Diese Liste ist deine Priorität.',
                ru: 'Это не для того, чтобы напугать: будь эта неделя последней, какие пункты твоего списка вдруг обессмыслились бы, а какие зазвучали громче? Запиши те, что стали громче. Вот твой приоритет.',
                fr: "Ce n'est pas pour t'effrayer : si c'était ta dernière semaine, quels points de ta liste perdraient soudain tout sens, et lesquels monteraient ? Note ceux qui montent. Cette liste-là est ta priorité.",
                es: 'Esto no es para asustarte: si esta fuera tu última semana, ¿qué puntos de tu lista perderían de golpe todo sentido y cuáles se harían más fuertes? Anota los que se hicieron más fuertes. Esa lista es tu prioridad.' } },
    ],
  },
];
